...
import template.cli.train
import template.cli.predict
...
train.set_defaults(main=template.cli.train.main)
...
predict.set_defaults(main=template.cli.predict.main)
