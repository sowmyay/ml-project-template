...
import keras_template.cli.train
import keras_template.cli.predict

parser = argparse.ArgumentParser(prog="keras_template")
...
train.add_argument("--num-gpus", type=int, default=0, help="number of gpus")
...
train.set_defaults(main=keras_template.cli.train.main)
...
predict.add_argument("--num-gpus", type=int, default=0, help="number of gpus")
predict.add_argument("--batch-size", type=int, default=64, help="number of items per batch")
predict.set_defaults(main=keras_template.cli.predict.main)
